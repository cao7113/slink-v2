defmodule SlinkWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SlinkWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import SlinkWeb.ConnCase
    end
  end

  setup tags do
    Slink.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = Slink.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Slink.Accounts.generate_user_session_token(user)
